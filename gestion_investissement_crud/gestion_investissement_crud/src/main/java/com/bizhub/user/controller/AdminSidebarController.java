        ...
        try {
            Platform.runLater(() -> {
                ...
                if (h1 instanceof javafx.scene.text.Text t) {
                    ...
                    else if (title.contains("projet")) NavigationService.setActiveNav(nameText.getParent(), NavigationService.ActiveNav.PROJECTS);
                    else if (title.contains("investissement")) NavigationService.setActiveNav(nameText.getParent(), NavigationService.ActiveNav.INVESTMENTS);
                }
            });
