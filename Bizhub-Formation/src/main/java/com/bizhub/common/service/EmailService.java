...
/**
 * Envoi d'emails (validation participation).
...
public class EmailService {
    ...
    static {
        ...
        try (InputStream is = EmailService.class.getResourceAsStream("/application.properties")) {
            if (is != null) {
                fileProps.load(is);
            }
    ...
    public boolean sendParticipationConfirmation(User user, Formation formation, Participation participation) {
        ...
        try {
            ...
            msg.setRecipients(Message.RecipientType.TO, InternetAddress.parse(user.getEmail().trim()));
